            ...
            <div class="panel panel-default">
     			<div class="panel-heading">Edit Buku</div>
    				<div class="panel-body">
                        <form class="form-horizontal" method="POST" action="<?php echo e(route('updateDistributor.distributor', $distributor->id )); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('nama_distributor') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="nama_distributor" type="text" class="form-control" name="nama_distributor" value="<?php echo e($distributor->nama_distributor); ?>" required autofocus>
                            ...
                            <div class="form-group<?php echo e($errors->has('alamat') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="alamat" type="text" class="form-control" name="alamat" value="<?php echo e($distributor->alamat); ?>" required autofocus>
                            ...
                            <div class="form-group<?php echo e($errors->has('telepon') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="telepon" type="text" class="form-control" name="telepon" value="<?php echo e($distributor->telepon); ?>" required autofocus>
