        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
				...
				<div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('store.buku')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('judul') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="judul" type="text" class="form-control" name="judul" value="<?php echo e(old('judul')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('noisbn') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="noisbn" type="text" class="form-control" name="noisbn" value="<?php echo e(old('noisbn')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('penulis') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="penulis" type="text" class="form-control" name="penulis" value="<?php echo e(old('penulis')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('penerbit') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="penerbit" type="text" class="form-control" name="penerbit" value="<?php echo e(old('penerbit')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('tahun') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="tahun" type="date" class="form-control" name="tahun" value="<?php echo e(old('tahun')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('stok') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="stok" type="text" class="form-control" name="stok" value="<?php echo e(old('stok')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('harga_pokok') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="harga_pokok" type="text" class="form-control" name="harga_pokok" value="<?php echo e(old('harga_pokok')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('harga_jual') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="harga_jual" type="text" class="form-control" name="harga_jual" value="<?php echo e(old('harga_jual')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('ppn') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="ppn" type="text" class="form-control" name="ppn" value="<?php echo e(old('ppn')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('diskon') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="diskon" type="text" class="form-control" name="diskon" value="<?php echo e(old('diskon')); ?>" required autofocus>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-success">
                                    <span class="glyphicon glyphicon-ok"></span> Tambah Buku
                                </button>
                                <a href="<?php echo e(url('home/buku')); ?>" class="btn btn-danger">
