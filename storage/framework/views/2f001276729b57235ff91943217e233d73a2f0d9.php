    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
     			<div class="panel-heading">Detail pada buku <b><?php echo e($edit->judul); ?></b></div>
    				<div class="panel-body">
                            ...
                            <div class="form-group<?php echo e($errors->has('judul') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="judul" type="text" class="form-control" name="judul" value="<?php echo e($edit->judul); ?>" readonly>
                            ...
                            <div class="form-group<?php echo e($errors->has('noisbn') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="noisbn" type="text" class="form-control" name="noisbn" value="<?php echo e($edit->noisbn); ?>" readonly>
                            ...
                            <div class="form-group<?php echo e($errors->has('penulis') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="penulis" type="text" class="form-control" name="penulis" value="<?php echo e($edit->penulis); ?>" readonly>
                            ...
                            <div class="form-group<?php echo e($errors->has('penerbit') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="penerbit" type="text" class="form-control" name="penerbit" value="<?php echo e($edit->penerbit); ?>" readonly>
                            ...
                            <div class="form-group<?php echo e($errors->has('tahun') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="tahun" type="date" class="form-control" name="tahun" value="<?php echo e($edit->tahun); ?>" readonly>
                            ...
                            <div class="form-group<?php echo e($errors->has('stok') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="stok" type="text" class="form-control" name="stok" value="<?php echo e($edit->stok); ?>" readonly>
                            ...
                            <div class="form-group<?php echo e($errors->has('harga_pokok') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="harga_pokok" type="text" class="form-control" name="harga_pokok" value="<?php echo e($edit->harga_pokok); ?>" readonly>
                            ...
                            <div class="form-group<?php echo e($errors->has('harga_jual') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="harga_jual" type="text" class="form-control" name="harga_jual" value="<?php echo e($edit->harga_jual); ?>" readonly>
                            ...
                            <div class="form-group<?php echo e($errors->has('ppn') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="ppn" type="text" class="form-control" name="ppn" value="<?php echo e($edit->ppn); ?>" readonly>
                            ...
                            <div class="form-group<?php echo e($errors->has('diskon') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    <input id="diskon" type="text" class="form-control" name="diskon" value="<?php echo e($edit->diskon); ?>" readonly>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    <a href="<?php echo e(route('edit.buku', $edit->id)); ?>" class="btn btn-warning">
                                        <span class="glyphicon glyphicon-pencil"></span> Edit Buku
                                    </a>
