                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('status') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="status" type="text" class="form-control" name="status" value="<?php echo e(old('status')); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('nohp') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="nohp" type="text" class="form-control" name="nohp" value="<?php echo e(old('nohp')); ?>" required>
