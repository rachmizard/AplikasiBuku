    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
     			<div class="panel-heading">Detail pada buku <b>{{ $edit->judul }}</b></div>
    				<div class="panel-body">
                            ...
                            <div class="form-group{{ $errors->has('judul') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="judul" type="text" class="form-control" name="judul" value="{{ $edit->judul }}" readonly>
                            ...
                            <div class="form-group{{ $errors->has('noisbn') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="noisbn" type="text" class="form-control" name="noisbn" value="{{ $edit->noisbn }}" readonly>
                            ...
                            <div class="form-group{{ $errors->has('penulis') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="penulis" type="text" class="form-control" name="penulis" value="{{ $edit->penulis}}" readonly>
                            ...
                            <div class="form-group{{ $errors->has('penerbit') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="penerbit" type="text" class="form-control" name="penerbit" value="{{ $edit->penerbit }}" readonly>
                            ...
                            <div class="form-group{{ $errors->has('tahun') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="tahun" type="date" class="form-control" name="tahun" value="{{ $edit->tahun }}" readonly>
                            ...
                            <div class="form-group{{ $errors->has('stok') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="stok" type="text" class="form-control" name="stok" value="{{ $edit->stok }}" readonly>
                            ...
                            <div class="form-group{{ $errors->has('harga_pokok') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="harga_pokok" type="text" class="form-control" name="harga_pokok" value="{{ $edit->harga_pokok }}" readonly>
                            ...
                            <div class="form-group{{ $errors->has('harga_jual') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="harga_jual" type="text" class="form-control" name="harga_jual" value="{{ $edit->harga_jual }}" readonly>
                            ...
                            <div class="form-group{{ $errors->has('ppn') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="ppn" type="text" class="form-control" name="ppn" value="{{ $edit->ppn }}" readonly>
                            ...
                            <div class="form-group{{ $errors->has('diskon') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="diskon" type="text" class="form-control" name="diskon" value="{{ $edit->diskon }}" readonly>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    <a href="{{route('edit.buku', $edit->id)}}" class="btn btn-warning">
